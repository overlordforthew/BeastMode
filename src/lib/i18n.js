export const TRANSLATIONS = {
  en: {
    ...
    onbBullet2Title: "2-MINUTE RESET",
    onbBullet2Body: "A quick bodyweight move or meditation — plank, pushups, breath. Pick any duration later.",
    ...
    onbEnableNudges: "ENABLE NUDGES & START \uD83D\uDD25",
    onbLetsGo: "LET'S GO \uD83D\uDD25",
    onbNotNow: "Not now",
  ...
  es: {
    ...
    onbBullet2Title: "RESET DE 2 MIN",
    onbBullet2Body: "Un ejercicio rápido o meditación — plancha, flexiones, respiración. La duración la cambias después.",
    ...
    onbEnableNudges: "ACTIVAR AVISOS Y EMPEZAR \uD83D\uDD25",
    onbLetsGo: "\u00A1VAMOS! \uD83D\uDD25",
    onbNotNow: "Ahora no",
  ...
  ja: {
    ...
    onbBullet2Title: "2分リセット",
    onbBullet2Body: "素早いエクササイズか瞑想 — プランク、腕立て、呼吸法。時間は後で変更できます。",
